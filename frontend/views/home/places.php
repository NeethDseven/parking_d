        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Formulaire de réservation --><?php if (isset($_SESSION['user'])): ?>
                        ...
                        <form action="<?php echo BASE_URL; ?>reservation/createAlert" method="post" id="alert-form" class="hidden"> <input type="hidden" name="place_id" id="alert_place_id" value="">
                        ...
                        </form> <!-- Logique des alertes maintenant dans unifiedReservationManager.js --><!-- Logique de réservation maintenant dans unifiedReservationManager.js -->
                        ...
                        <?php if (isset($userSubscriptionBenefits) && $userSubscriptionBenefits): ?>
                            <div id="subscription-benefits" class="d-none"
                                ...
                                data-subscription-name="<?php echo htmlspecialchars($userSubscriptionBenefits['subscription_name']); ?>"> </div> <?php endif; ?>
