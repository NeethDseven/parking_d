<?php
$title = 'Modifier l\'abonnement - ' . APP_NAME;
    ...
    <div class="content">
        <div class="container-fluid p-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo BASE_URL; ?>subscription/update/<?php echo $subscription['id']; ?>" method="post">
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="price" name="price" step="0.01" min="0" value="<?php echo $subscription['price']; ?>" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="duration_days" class="form-label">Durée (jours) *</label>
                                <input type="number" class="form-control" id="duration_days" name="duration_days" min="1" value="<?php echo $subscription['duration_days']; ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label for="free_minutes" class="form-label">Minutes gratuites</label>
                                <input type="number" class="form-control" id="free_minutes" name="free_minutes" min="0" value="<?php echo $subscription['free_minutes']; ?>">
                            </div>
                            <div class="col-md-4">
                                <label for="discount_percent" class="form-label">Réduction (%)</label>
                                <input type="number" class="form-control" id="discount_percent" name="discount_percent" min="0" max="100" step="0.01" value="<?php echo $subscription['discount_percent']; ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($subscription['description']); ?></textarea>
                        </div>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" <?php echo $subscription['is_active'] ? 'checked' : ''; ?>>
