...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 20 juin 2025 à 04:04
...
(114, 7, 'Réservation annulée', 'Votre réservation #132 a été annulée.', '', 0, '2025-06-20 00:08:40');
...
(151, 7, 47, '2025-06-20 03:53:00', '2025-06-20 04:23:00', 'confirmée', '9BAEC6', NULL, 0.19, 0.00, 0, '2025-06-20 01:52:00', '2025-06-20 04:07:00', NULL, NULL, NULL, NULL),
...
--
-- Contraintes pour la table `alertes_disponibilite`
--
ALTER TABLE `alertes_disponibilite`
...
--
-- Contraintes pour la table `availability_alerts`
--
ALTER TABLE `availability_alerts`
...
--
-- Contraintes pour la table `tarif_historique`
--
ALTER TABLE `tarif_historique`
...
--
-- Contraintes pour la table `user_abonnements`
--
ALTER TABLE `user_abonnements`
