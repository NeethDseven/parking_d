...
class LogModel
{
    ...
    {
        try {
            // Mettre à jour les logs pour remplacer l'ID de l'utilisateur par NULL (anonyme)
            // Utiliser NULL au lieu de 0 pour éviter les conflits avec les clés primaires
            $data = ['user_id' => null];
            $where = 'user_id = :user_id';
